...
export class DriversService {
  ...
  async updateLocation(
    ...
    this.driversGateway.broadcastDriverLocation({
      ...
      currentLat: (updatedDriver as any).currentLat!,
      currentLng: (updatedDriver as any).currentLng!,
  ...
  private mapToDriverResponse(
    ...
    return {
      ...
      profilePicture: driver.profilePicture ?? undefined,
      role: driver.role as 'CUSTOMER' | 'DRIVER' | 'ADMIN',
      isActive: driver.isActive,
      licenseNumber: driver.licenseNumber ?? undefined,
      vehicleNumber: driver.vehicleNumber ?? undefined,
      vehicleType: driver.vehicleType as 'MOTORCYCLE' | 'CAR' | 'VAN' | 'TRUCK' | undefined,
      ...
      driverApplicationStatus: driver.driverApplicationStatus as 'NOT_APPLIED' | 'PENDING' | 'APPROVED' | 'REJECTED' | undefined,
