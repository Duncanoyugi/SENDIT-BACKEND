...
export class ParcelsService {
  ...
  private isValidStatusTransition(
    ...
    // Convert status to lowercase to handle case sensitivity issues
  ...
  private mapToParcelResponse(
    ...
    return {
      ...
      status: parcel.status as 'pending' | 'assigned' | 'picked_up' | 'in_transit' | 'delivered_to_recipient' | 'delivered' | 'completed' | 'cancelled',
      ...
      paymentStatus: parcel.paymentStatus as 'PENDING' | 'PAID' | 'FAILED' | 'REFUNDED',
  ...
  private mapToUserResponse(user: User): UserResponseDto {
    return {
      ...
      vehicleType: user.vehicleType as 'MOTORCYCLE' | 'CAR' | 'VAN' | 'TRUCK' | undefined,
      ...
      driverApplicationStatus: user.driverApplicationStatus as 'NOT_APPLIED' | 'PENDING' | 'APPROVED' | 'REJECTED' | undefined,
