  ...
  async uploadProfilePicture(
    ...
    try {
      ...
      if (error.message?.includes('Cloudinary is not configured')) {
        this.logger.warn('Profile picture upload skipped - Cloudinary not configured');
        throw new BadRequestException('Profile picture upload is not available. Please configure Cloudinary credentials.');
      }
