...
export class AdminService {
  ...
  async getDriverComprehensiveData(driverId: string): Promise<{
    ...
    console.log(`  Parcel Reviews:`, driverReviews.map(r => ({ rating: r.rating, parcelId: r.parcelId })));
    console.log(`  Direct Reviews:`, directDriverReviews.map(r => ({ rating: r.rating, parcelId: r.parcelId })));
