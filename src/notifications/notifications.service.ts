...
export class NotificationsService {
  ...
  private mapToNotificationResponse(
    ...
    return {
      ...
      type: notification.type as 'PARCEL_CREATED' | 'PARCEL_ASSIGNED' | 'PARCEL_PICKED_UP' | 'PARCEL_IN_TRANSIT' | 'PARCEL_DELIVERED_TO_RECIPIENT' | 'PARCEL_DELIVERED' | 'PARCEL_COMPLETED' | 'DRIVER_ASSIGNED' | 'PAYMENT_RECEIVED' | 'REVIEW_RECEIVED',
