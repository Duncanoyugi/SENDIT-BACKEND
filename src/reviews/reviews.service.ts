...
interface ReviewWithRelations {
  ...
  reviewee?: UserWithRelations | null;
}
...
export class ReviewsService {
  ...
  async create(
    ...
    return this.mapToReviewResponse(review as unknown as ReviewWithRelations);
  }
  ...
  async findAll(
    ...
    return {
      reviews: reviews.map((review) =>
        this.mapToReviewResponse(review as unknown as ReviewWithRelations),
      ),
      total,
      page,
      limit,
  ...
  async update(
    ...
    return this.mapToReviewResponse(updatedReview as unknown as ReviewWithRelations);
  }
  ...
  async getDriverReviewSummary(driverId: string): Promise<ReviewSummaryDto> {
    ...
    const recentReviews = reviews
      .slice(0, 5)
      .map((review) => this.mapToReviewResponse(review as unknown as ReviewWithRelations));
